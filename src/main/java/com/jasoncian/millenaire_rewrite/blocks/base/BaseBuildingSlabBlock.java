...
/**
 * 基础建筑台阶方块 - 1.20.1现代化实现
 *
 * 基于BaseBuildingBlock的台阶方块实现，
 * 提供统一的台阶方块行为和属性继承。
 *
 * 功能特性：
 * - 继承基础方块的所有属性
 ...
 * @version 1.0.0
 */
public class BaseBuildingSlabBlock extends SlabBlock {
     ...
     * @param culture 文化系列
     */
    public BaseBuildingSlabBlock(BasicBuildingMaterial baseMaterial, CulturalBlockFamily culture) {
        super(BaseBuildingBlock.createProperties(baseMaterial.getMaterialProperties()));
        this.baseMaterial = baseMaterial;
        this.culture = culture;
        this.blockName = baseMaterial.generateBlockRegistryName(culture, BlockVariantType.SLAB);
    }
    ...
    public String getTranslationKey() {
        return baseMaterial.generateTranslationKey(culture, BlockVariantType.SLAB);
    }
}
