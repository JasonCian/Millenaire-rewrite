 ...
 * - 方块物品栏：包含所有建筑方块
 * - 华夏文化物品栏：华夏文化专属物品和方块
 * - 调试工具物品栏：开发和调试用物品（如村民蛋等）
 * 
 * 其他文化物品栏会在相应文化内容开发完成后添加。
 * 
...
public final class ModCreativeTabs {
    ...
    /** 千年村庄主物品栏 */
    // public static final RegistryObject<CreativeModeTab> MILLENAIRE_TAB =
    ...
    /** 千年村庄华夏文化物品栏 */
    public static final RegistryObject<CreativeModeTab> MILLENAIRE_HUAXIA_TAB = CREATIVE_MODE_TABS.register(
            "millenaire_huaxia_tab",
            () -> CreativeModeTab.builder()
                    .icon(() -> new ItemStack(ModItems.HUAXIA_GOLD_INGOT.get())) // 使用华夏金元宝作为图标
                    .title(Component.translatable("creativetab.millenaire_rewrite.millenaire_huaxia_tab"))
                    .displayItems((parameters, output) -> {
                        // ===== 华夏文化物品 =====
    ...
    /** 千年村庄调试工具物品栏 */
    public static final RegistryObject<CreativeModeTab> MILLENAIRE_DEBUG_TAB = CREATIVE_MODE_TABS.register(
            "millenaire_debug_tab",
            () -> CreativeModeTab.builder()
                    .icon(() -> new ItemStack(ModItems.MILL_VILLAGER_SPAWNER.get())) // 使用村民蛋作为图标
                    .title(Component.translatable("creativetab.millenaire_rewrite.millenaire_debug_tab"))
                    .displayItems((parameters, output) -> {
                        // ===== 调试和开发工具 =====
                        ...
                        // output.accept(ModItems.VILLAGE_WAND.get());
                        // output.accept(ModItems.CULTURE_SCROLL.get());
                        // output.accept(ModItems.DEBUG_INFO_TOOL.get());
                        // output.accept(ModItems.STRUCTURE_BUILDER_WAND.get());
                        // output.accept(ModItems.QUEST_DEBUG_TOOL.get());
                    })
                    .build());
